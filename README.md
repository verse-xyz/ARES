...
You don’t have to keep up with 10 different discord channels. You don’t have to participate in lengthy governance processes. You don’t have to argue with other holders over a “roadmap”. You just create and curate other people’s creations; that’s the only way to proliferate the meme. The mental model here is a shift from being part of a static collection with a bunch of external dependencies to being an active node in a fluid, self-sustaining network. This is a new medium for creative networks that are actually non-skeuomorphic, and crypto-native.
